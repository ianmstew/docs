module.exports = function( app ) {
	...
	app.get( '/genericUri/facebook/ownerfriends', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/contacts" }
		);
	} );
	app.get( '/sampleUri/facebook/ownerfriends', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner  + '/contacts'
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownernews', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/fnews" }
		);
	} );
	app.get( '/sampleUri/facebook/ownernews', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/fnews'
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownerstatus', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/fstatuses" }
		);
	} );
	app.get( '/sampleUri/facebook/ownerstatus', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/fstatuses' 
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownerevents', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/fevents" }
		);
	} );
	app.get( '/sampleUri/facebook/ownerevents', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/fevents' 
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownergroups', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/fgroups" }
		);
	} );
	app.get( '/sampleUri/facebook/ownergroups', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/fgroups' 
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownerlikes', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/flikes" }
		);
	} );
	app.get( '/sampleUri/facebook/ownerlikes', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/flikes'
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownerlinks', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/flinks" }
		);
	} );
	app.get( '/sampleUri/facebook/ownerlinks', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/flinks' 
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownerphotos', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/fphotos" }
		);
	} );
	app.get( '/sampleUri/facebook/ownerphotos', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/fphotos'
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownerposts', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/fposts" }
		);
	} );
	app.get( '/sampleUri/facebook/ownerposts', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/fposts'
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/owneralbums', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/falbums" }
		);
	} );
	app.get( '/sampleUri/facebook/owneralbums', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/falbums' 
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownernotes', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/fnotes" }
		);
	} );
	app.get( '/sampleUri/facebook/ownernotes', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/fnotes' 
			} );
		}
	} );
	...
	app.get( '/genericUri/facebook/ownervideos', function( req, res ) {
		res.json( 
			{ "uri": "ldengine://{owner}//@acct:facebook:{accountID}/fvideos" }
		);
	} );
	app.get( '/sampleUri/facebook/ownervideos', function( req, res ) {
		...
		else
		{
			var userId = tokens.owner.substring( 9 );
			res.json( { 
				"uri": 'ldengine://' + tokens.owner + '//@acct:' + tokens.owner + '/fvideos' 
			} );
		}
	} );
