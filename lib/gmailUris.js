module.exports = function( app ) {
	app.get( '/genericUri/gmail/userprofile', function( req, res ) {
		res.json( {
			"uri": "apinetwork://{owner}//@acct:gmail:{accountID}/user/{userID}"
		});
	} );
	...
	app.get( '/genericUri/gmail/mailboxes', function( req, res ) {
		res.json( {
			"uri": "apinetwork://{owner}//@acct:gmail:{accountID}/mailbox/_index"
		});
	} );
	...
	app.get( '/genericUri/gmail/boxindex', function( req, res ) {
		res.json( {
			"uri": "apinetwork://{owner}//@acct:gmail:{accountID}/mailbox/{mailboxName}"
		});
	} );
	...
	app.get( '/genericUri/gmail/messageGmailId', function( req, res ) {
		res.json( {
			"uri": "apinetwork://{owner}//@acct:gmail:{accountID}/message/x-gm-msgid/{messageID}"
		});
	} );
	app.get( '/sampleUri/gmail/messageGmailId', function( req, res ) {
		...
		else
		{
			...
			res.json( { 
				"uri": 'apinetwork://' + tokens.owner + '//@acct:' + tokens.owner + '/message/' + mailboxName + '/x-gm-msgid/' + messageId
			} );
		}
	} );
	...
	app.get( '/genericUri/gmail/messageHeaderId', function( req, res ) {
		res.json( {
			"uri": "apinetwork://{owner}//@acct:gmail:{accountID}/message/{mailboxName}/message-id/{msgID}"
		});
	} );
	...
	app.get( '/genericUri/gmail/messageServerId', function( req, res ) {
		res.json( {
			"uri": "apinetwork://{owner}//@acct:gmail:{accountID}/message/{mailboxName}/uid/{msgID}"
		});
	} );
	...
	app.get( '/genericUri/gmail/messageSequenceNumber', function( req, res ) {
		res.json( {
			"uri": "apinetwork://{owner}//@acct:gmail:{accountID}/message/{mailboxName}/{seqNumber}"
		});
	} );
